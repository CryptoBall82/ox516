...
export default function TrainingLegendsPage() {
  ...
  const tlLogoUrl = {tlImage}; // Replace with actual logo URL and token if available
    ...
    <div className="flex flex-col h-screen items-center mx-auto max-w-[500px]">
      ...
      <div className="flex-grow relative w-full">
          <div className="flex justify-center relative mb-4">
            {/* Page Title */}
            <span
              className="absolute font-bold text-2xl text-white whitespace-nowrap" // Added whitespace-nowrap
              style={{
                  top: '90px',
                  left: '50%',
